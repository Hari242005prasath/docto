...
import { ArrowRight, Upload, FileText, Shield, Users, CheckCircle, Stethoscope, Eye, ClipboardCheck } from "lucide-react"
    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1">
          ...
          {/* Update the Disease Detection Section */}
          <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-teal-50 to-blue-50">
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Upload your medical images for instant AI-powered analysis
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-8">
                {/* Chest X-Ray Detection Card */}
                <div className="flex flex-col items-center space-y-4 p-6 rounded-xl border bg-white shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold">Chest X-Ray Analysis</h3>
                  <p className="text-center text-gray-500">
                    Detect COVID-19, Pneumonia, and other chest-related conditions from X-ray images
                  </p>
                  <Link href="/patient/disease-detection">
                ...
                <div className="flex flex-col items-center space-y-4 p-6 rounded-xl border bg-white shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold">Skin Disease Analysis</h3>
                  <p className="text-center text-gray-500">
                    Identify various skin conditions and get personalized treatment recommendations
                  </p>
                  <Link href="/patient/skin-detection">
                    <Button size="lg" className="w-full">
                      Start Analysis
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6">Specialized External Analysis</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {/* Eye Condition Analysis */}
              <div className="rounded-lg border p-6">
                <div className="flex items-center gap-2 mb-4">
                  <Eye className="h-6 w-6" />
                  <h3 className="text-xl font-semibold">Eye Condition Analysis</h3>
                </div>
                <p className="text-gray-600 mb-4">
                  AI analysis of eye photos for common conditions and vision problems
                </p>
              ...
              <div className="rounded-lg border p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Skin Disease Detection</h3>
                </div>
                <p className="text-gray-600 mb-4">
                  Upload photos of skin conditions for instant AI analysis
                </p>
                <div className="w-full">
                  <Link href="/patient/skin-detection" className="w-full">
              ...
              {/* External Symptoms Check */}
              <div className="rounded-lg border p-6">
                <div className="flex items-center gap-2 mb-4">
                  <ClipboardCheck className="h-6 w-6" />
                  <h3 className="text-xl font-semibold">External Symptoms Check</h3>
                </div>
                <p className="text-gray-600 mb-4">
                  Analysis of visible symptoms and physical conditions
                </p>
                <div className="w-full">
                  <Button variant="outline" className="w-full">
                    Learn More
          ...
          <section className="mt-12">
            <h2 className="text-2xl font-bold mb-6">Medical Image Analysis</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {/* ... other cards ... */}
            </div>
          </section>
